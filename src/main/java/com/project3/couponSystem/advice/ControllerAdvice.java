package com.project3.couponSystem.advice;
...
public class ControllerAdvice {
    @ExceptionHandler(value = {CouponSystemException.class, SecurityException.class})
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrDetails handleError(Exception e){
        return new ErrDetails("project stage 3",e.getMessage());
    }
